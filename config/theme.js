const themes = {
  ...
  darkMode: {
    ...
    image_overlay_gradient: 'linear-gradient(180deg, rgba(0,0,0,0.60) 0%, rgba(0,0,0,0.05) 100%)',
  ...
  lightMode: {
    ...
    image_overlay_gradient: 'linear-gradient(180deg, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.10) 100%)',
    image_overlay_darkgradient: 'linear-gradient(180deg, rgba(0,0,0,0.60) 0%, rgba(0,0,0,0.20) 100%)',
    image_opacity: '1',
    toggle_track: '#999999',
