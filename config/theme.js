const themes = {
  ...
  darkMode: {
    ...
    image_overlay_gradient: 'linear-gradient(180deg, rgba(0,0,0,0.80) 0%, rgba(0,0,0,0.15) 100%)',
    toggle_track: '#333333',
  ...
  lightMode: {
    ...
    image_overlay_gradient: 'linear-gradient(180deg, rgba(0,0,0,0.72) 0%, rgba(0,0,0,0.10) 100%)',
    toggle_track: '#999999',
